...
namespace AirlineReservationSystem
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-2KBR036;Initial Catalog=ARS;Integrated Security=True");
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string firstQuery = "INSERT INTO Airplane(Airplane_ID, Airline_ID, RegNumber, Seats, Category) values(@id, @airlineID, @rg, @seats, @cat)";
